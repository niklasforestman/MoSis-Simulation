...
while sim_continue(population):
    ...
    if count == 12:
        print("Tag: ",day_counter,".....","Isolationsaufruf: ",isolation_enabled,".....","r0: ", round(r0_current[day_counter],4),".....","aktuell Infizierte: ", round(people_infected[day_counter],4),".....","Dunkelziffer: ",round(darkfigure[day_counter],3),".....","aktuell Immune: ",round(people_immune[day_counter],4),".....","aktuell Verstorbene: ",round(people_dead[day_counter],4),".....",people_infected[day_counter]/people_infected[day_counter-1])
        count = 0
    #time.sleep(0.9)
